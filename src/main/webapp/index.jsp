Sure — here is the **complete NexusShop code with the green colour theme applied**. I kept the existing layout and functionality, but changed the main colour palette from coral to green.
...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --shadow: 0 4px 24px rgba(23, 35, 27, 0.06);
            --shadow-hover: 0 12px 48px rgba(23, 35, 27, 0.10);
        ...
        * {
        ...
        .btn-secondary:hover {
            ...
            transform: translateY(-2px);
            box-shadow: 0 8px 24px rgba(23, 35, 27, 0.20);
        }

        .btn-outline {
            background: transparent;
            color: var(--primary);
            border-color: rgba(23, 35, 27, 0.15);
        }
        ...
        header {
            ...
            border-bottom: 1px solid rgba(23, 35, 27, 0.04);
        }
        ...
        #mobileMenu {
            display: none;
            background: #fff;
            border-top: 1px solid rgba(23, 35, 27, 0.04);
            padding: 12px 0 20px;
        }
...
<body>
    ...
    <main>
        ...
        <section class="hero" aria-label="Hero banner">
            ...
            <div class="container">
                ...
                <p>
                    Curated fashion, tech & accessories with free
                    shipping on your first order. Limited-time deals await.
                </p>
                ...
                <div class="deal-wrap">
                    ...
                    <div class="deal-content">
                        ...
                        <p class="desc">
                            ...
                            the M2 chip redefines performance.
                        </p>
            ...
            <div class="container">
                ...
                <div class="newsletter-wrap">
                    ...
                    <div class="text">
                        ...
                        <p>
                            Get exclusive offers, early access & new arrivals
                        </p>
        ...
        <div class="container">
            ...
            <div class="footer-grid">
                ...
                <div class="brand-col">
                    ...
                    <p>
                        Modern e-commerce demo built with care.
    ...
    <script>
        ...
        console.log(
            '🚀 NexusShop — Green theme loaded successfully.'
        );
...
```
 ...
 This version uses a **deep green + emerald + soft mint** palette throughout, including the hero, buttons, logo, cards, hover effects, search focus, cart badge, newsletter, and links.
