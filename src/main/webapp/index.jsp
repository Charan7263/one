  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .btn {
      ...
      padding: 12px 28px; border-radius: 60px; font-weight: 600; font-size: 15px;
      transition: var(--transition); border: 2px solid transparent;
    }
    .btn-primary { background: var(--accent); color: #fff; border-color: var(--accent); }
    .btn-primary:hover { background: var(--accent-dark); border-color: var(--accent-dark); transform: translateY(-2px); box-shadow: 0 10px 24px rgba(217,108,74,0.25); }
    .btn-secondary { background: var(--primary); color: #fff; border-color: var(--primary); }
    .btn-secondary:hover { background: var(--primary-light); border-color: var(--primary-light); transform: translateY(-2px); box-shadow: 0 10px 24px rgba(0,0,0,0.12); }
    .btn-outline { background: transparent; color: var(--primary); border-color: rgba(0,0,0,0.10); }
    ...
    .btn-ghost:hover { background: rgba(255,255,255,0.2); border-color: rgba(255,255,255,0.3); transform: translateY(-2px); }
    ...
    .header-inner {
      ...
      padding: 12px 0; min-height: 70px;
    }
    .brand {
    ...
    .search-wrap {
      ...
      border-radius: 60px; padding: 0 16px 0 20px;
      transition: var(--transition); border: 2px solid transparent;
      min-width: 200px;
    }
    .search-wrap:focus-within {
      border-color: var(--accent); background: #fff; box-shadow: 0 0 0 4px rgba(217,108,74,0.08);
    }
    .search-wrap input {
    ...
    .hero {
      ...
      min-height: 440px; padding: 60px 0;
    ...
    .hero .badge {
      display: inline-block; background: rgba(217,108,74,0.18); color: var(--accent);
      padding: 4px 18px; border-radius: 60px; font-weight: 600; font-size: 13px;
      letter-spacing: 0.3px; margin-bottom: 16px;
    }
    .hero h1 {
      font-family: 'Playfair Display', serif; font-size: 46px; font-weight: 700;
      color: #fff; line-height: 1.15; max-width: 580px; margin-bottom: 14px;
    }
    .hero p {
      color: rgba(255,255,255,0.78); font-size: 17px; max-width: 500px;
    ...
    .section-header .view-all {
      font-weight: 600; color: var(--accent); display: flex; align-items: center;
      gap: 6px; font-size: 14px; transition: var(--transition); white-space: nowrap;
    }
    ...
    .product-card .badge {
      ...
      border-radius: 60px; font-size: 11px; font-weight: 700;
    ...
    .product-card .body .rating { display: flex; align-items: center; gap: 4px; font-size: 13px; color: #e6b422; }
    ...
    .deal-wrap .deal-img { flex: 0 0 46%; background: var(--surface); min-height: 260px; }
    ...
    .deal-wrap .deal-content .tag {
      ...
      padding: 4px 14px; border-radius: 60px; font-size: 12px; font-weight: 700;
    ...
    .deal-wrap .deal-content .price-big .old { font-size: 20px; font-weight: 400; color: var(--muted-light); text-decoration: line-through; margin-left: 10px; }
    ...
    .timer-grid { display: flex; gap: 12px; margin: 16px 0 18px; }
    .timer-box { background: var(--primary); color: #fff; padding: 10px 14px; border-radius: var(--radius-sm); min-width: 64px; text-align: center; }
    .timer-box .num { font-size: 24px; font-weight: 700; line-height: 1.2; }
    .timer-box .label { font-size: 10px; opacity: 0.7; text-transform: uppercase; letter-spacing: 0.4px; }
    ...
    .testimonial-card {
      flex: 0 0 320px; background: var(--bg-card); border-radius: var(--radius);
      padding: 24px 26px; box-shadow: var(--shadow); scroll-snap-align: start;
      transition: var(--transition);
    }
    .testimonial-card:hover { box-shadow: var(--shadow-hover); }
    .testimonial-card .stars { color: #e6b422; font-size: 16px; letter-spacing: 2px; margin-bottom: 8px; }
    ...
    .newsletter-wrap form input {
      flex: 1; min-width: 180px; padding: 14px 20px; border-radius: 60px;
    ...
    /* ────────────── footer ────────────── */
    footer { margin-top: 12px; padding: 40px 0 24px; border-top: 1px solid rgba(0,0,0,0.03); }
    .footer-grid {
    ...
    .footer-grid .brand-col .socials a {
      ...
      display: grid; place-items: center; color: var(--muted); transition: var(--transition); font-size: 16px;
    }
    ...
    .footer-bottom { text-align: center; padding-top: 18px; border-top: 1px solid rgba(0,0,0,0.03); color: var(--muted-light); font-size: 13px; }
    ...
    @media (max-width: 480px) {
      ...
      .hero { margin: 8px 8px 0; min-height: 270px; padding: 24px 0; border-radius: var(--radius-sm); }
      ...
      .timer-box { min-width: 44px; padding: 6px 6px; }
